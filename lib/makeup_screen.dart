      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildSectionTitle("رابعاً: اعتبارات التطبيق العملي على الخشبة"),
            const SizedBox(height: 8),
            _buildBulletPoint("مقاومة التعرق والحرارة: استخدام مواد تثبيت خاصة تضمن ثبات المكياج تحت درجات حرارة كشافات المسرح العالية طوال فترة العرض."),
            _buildBulletPoint("اختبار المسافة: مراعاة أن الملامح المرسومة يجب أن تبدو مقنعة ليس فقط عن قرب، بل للمشاهد الجالس في الصفوف المتأخرة من الصالة."),
