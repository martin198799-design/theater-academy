  ...
  final List<Map<String, String>> lightingTopics = const [
    {
      ...
      'description': 'كيف تتحрі الإضاءة عن العواطف وتخلق الأبعاد النفسية والدرامية للمشهد.',
    ...
    {
      'title': 'تدرجات الألوان وتأثيراتها البصرية',
      'description': 'ربط الألوان الضوئية بالمناخ العام للعرض وتطور الأحداث الدرامية.',
      'category': 'التشكيل البصري'
    },
    {
      'title': 'أنظمة التحكم والإضاءة الحديثة',
      'description': 'تقنيات الـ LED الحديثة وبرمجة الإجواء الضوئية المتزامنة مع الحركة.',
      'category': 'التقنيات المعاصرة'
    },
  ];
